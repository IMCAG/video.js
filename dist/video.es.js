...
var SimpleCaptionsButton = function (_Button) {
  inherits(SimpleCaptionsButton, _Button);
   ...
   *        The function to call when this component is ready.
   */
  function SimpleCaptionsButton(player, options, ready) {
    classCallCheck(this, SimpleCaptionsButton);

    var _this = possibleConstructorReturn(this, _Button.call(this, player, options, ready));

    _this.language_ = options.playerOptions.language || 'en';
    return _this;
  }
  ...
  SimpleCaptionsButton.prototype.buildCSSClass = function buildCSSClass() {
  ...
  SimpleCaptionsButton.prototype.buildWrapperCSSClass = function buildWrapperCSSClass() {
    return 'vjs-captions-button ' + _Button.prototype.buildWrapperCSSClass.call(this);
  };
  ...
  SimpleCaptionsButton.prototype.handleClick = function handleClick(event) {
    var tracks = this.player().textTracks();
    var track = void 0;
    var targetTrack = void 0;
    var i = void 0;
